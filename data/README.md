...
Prepared from Cityscapes dataset

The version supported here is the finely annotated one with 2 classes (excluding unlabeled class) .

The dataset was obtained by applying instructions of ConvertTwoClass on Cityscapes and dividing the dataset into test, testannot, train , trainannot, val, valannot folders

A sample dataset can be downloaded from [website](https://drive.google.com/drive/folders/10OtkUu0cOsmtl-_d-_4ImZ3wIxYi6OfH?usp=sharing/) 
